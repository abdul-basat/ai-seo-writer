            ...
            <div className="mb-8">
              {Object.values(validatedKeys).some(isValid => isValid) ? (
                <div className="inline-flex items-center px-4 py-2 bg-green-100 text-green-800 rounded-full text-sm font-medium">
                  ...
                  {Object.values(validatedKeys).filter(isValid => isValid).length} AI provider(s) ready
                </div>
              ) : (
          ...
          <div className="space-y-8">
            ...
            <div className="mt-8 bg-gray-50 rounded-lg p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Save API Keys</h3>
                  <p className="text-sm text-gray-600 mt-1">
                    Keys are saved for this session only and will be cleared when you close the tab.
                  </p>
                </div>
                <button
              ...
              {Object.values(validatedKeys).some(isValid => isValid) && (
                <div className="mt-4 p-3 rounded-lg bg-green-50 border border-green-200">
                  <p className="text-sm text-green-800">
                    ...
                    Ready to generate content! Go to the Generate tab to create your first SEO content.
                  </p>
                </div>
              )}
            </div>
